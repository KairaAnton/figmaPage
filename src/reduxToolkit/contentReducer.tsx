...
const initialState = {
    navBtnContent: 'Start trading',
    languages:['Ru', 'uk', 'usa','pl'],
    navText: ['Instruments Categories', 'Tools', 'Company'],
    tradeDemo: {
    ...
    tradeTrust: {
        h: 'Trade with Trust',
        rules: {
            textColumn: 'Nordic Association of Brokers Ltd is a FTSE 250 company listed on the London Stock Exchange’s Main Market for Listed Companies',
            textSafe: 'Your funds are kept in segregated bank accounts',
            textLock: 'Secured by SSL'
        },
        btnContent: 'Read More About Us'
    },
    payment: '* Some of the payment methods may not be available in your country',
    takeControl: {
        h: 'Take Control',
    ...
    aboutUs:['Neroport business center in 2300 Copenhagen, Denmark','© 2015-2021'
    ]
};
